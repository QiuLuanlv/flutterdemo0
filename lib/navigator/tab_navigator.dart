      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        BottomNavigationBarItem(
          ...
          title: Text('首页',style: TextStyle(
            color: _cuttentindex!=0?_defaultColor:_activeColor
          ),)
        ),
        BottomNavigationBarItem(
            icon: Icon(
            ...
            title: Text('搜索',style: TextStyle(
                color: _cuttentindex!=1?_defaultColor:_activeColor
            ),)
        ),
        BottomNavigationBarItem(
            icon: Icon(
            ...
            title: Text('旅拍',style: TextStyle(
                color: _cuttentindex!=2?_defaultColor:_activeColor
            ),)
        ),
        BottomNavigationBarItem(
            icon: Icon(
            ...
            title: Text('我的',style: TextStyle(
                color: _cuttentindex!=3?_defaultColor:_activeColor
            ),)
        )
      ]),
    );
